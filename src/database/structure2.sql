...
(1,"Motherboard ASUS Prime Z590-A","Tarjeta madre Intel® Z590 (LGA 1200) ATX con PCIe® 4.0, tres puertos M.2, 16 fases de poder DrMOS, HDMI®, DisplayPort™, SATA 6 Gbps, Ethernet Intel® 2.5 Gb, USB 3.2 Gen 2x2 Tipo-C® y USB 3.2 Gen 1 Tipo-C® en el panel frontal, compatibilidad con Thunderbolt™ 4 e iluminación Aura Sync RGB","PRIME-Z590-A",3,"ARS",35000),
(2,"AMD Ryzen™ 7 5800X3D","El AMD Ryzen™ 7 5800X3D es el primer procesador de escritorio con caché L3 apilada, que ofrece unos inigualables 96 MB de caché L3 emparejados con núcleos increíblemente rápidos para crear el procesador de escritorio para juegos más rápido del mundo.","Ryzen 7 5800X3D",4,"ARS",70000),
...
(4,"DDR4 Corsair Dominator Platinum RGB","La memoria DDR4 CORSAIR DOMINATOR PLATINUM RGB redefine las memorias premium DDR4, con un diseño superior en aluminio, chips de memoria de alta frecuencia estrictamente verificados y 12 LED RGB CAPELLIX de direccionamiento individual y gran intensidad.","DDR4 CORSAIR DOMINATOR PLATINUM RGB",5,"ARS",60000),
...
(6,"Disco duro Barracuda 5TB","Todas las unidades de disco duro de la familia BarraCuda vienen equipadas con tecnología de almacenamiento en caché de múltiples niveles Multi-Tier Caching Technology (MTC). Al optimizar el flujo de datos con los niveles inteligentes de la tecnología de almacenamiento en caché de NAND Flash, DRAM y de medios, se pueden obtener tiempos de carga y aplicaciones más rápidos y mejorar el rendimiento de lectura y escritura.","Seagate Barracuda 5TB",6,"ARS",10000),
(7,"SSD 970 EVO NVMe M.2 500GB","Prepárate para vivir una experiencia PC de última generación. El SSD 970 EVO te ofrece unas velocidades de lectura y escritura sorprendentemente rápidas, una fiabilidad líder en el mercado, así como distintas capacidades de hasta 2 TB*. La última tecnología V-NAND, la nueva controladora Phoenix y tecnología Intelligent TurboWrite con las que disfrutarás al máximo de los juegos de alta gama y la edición gráfica 3D y 4K.","970 EVO NVMe M.2 500GB",6,"ARS",15000),
